...
describe("[Challenge] The rewarder", function () {
  ...
  it("Execution", async function () {
    ...
    const hackContractFactory = await ethers.getContractFactory(
      "HackContractRewardPool",
      player
    );
    ...
    console.log("Check attack with smart Contract");
    await hackContract.execute();
    const balance = ethers.utils.formatEther(
      await rewardToken.balanceOf(player.address)
    );
    console.log("Balance of HackContract", balance);
    console.log("Done!");
  });
